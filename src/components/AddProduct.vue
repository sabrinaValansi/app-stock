    ...
    <vue-form :state="formState" @submit.prevent="enviar()">
      <br>
       <validate tag="div">
        ...
        <input type="text" v-model.trim="formData.nombre" name="nombre" id="nombre" class="form-control mb-4" required :minlength="nombreMinLength">
        ...
        <input type="text" v-model.trim="formData.sku" name="sku" id="sku" class="form-control mb-4" required :minlength="skuLength">
        ...
        <input type="number" v-model="formData.precio" name="precio" class="form-control mb-4" required :min="minimo">
        ...
        <input type="number" v-model="formData.stock" name="stock" class="form-control mb-4" required :min="minimo">
        ...
        <select name="estado" id="estado" v-model="formData.estado" class="form-control mb-4">
